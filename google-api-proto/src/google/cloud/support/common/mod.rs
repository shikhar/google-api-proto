...
pub struct IssueTaxonomy {
    ...
    pub categories: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, issue_taxonomy::Category>,
}
...
pub mod issue_taxonomy {
    ...
    pub struct Category {
        ...
        pub components: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, Component>,
    }
}
